...
if uploaded_file:
    ...
    if selected_pol:
        ...
        if not grouped_df.empty:
            # Display results
            st.subheader(f"📦 Shipping Options from {selected_pol.upper()}")
            ...
            st.warning(f"No results found for '{selected_pol}'")
